...
do
    ...
    ri)
          ...
          xcodebuild -exportArchive -archivePath examples/cordova/cordova/platforms/ios/multible.xcarchive -exportPath /Volumes/tmp -exportOptionsPlist deploy/ios/exportOptions.plist
          ;;    
     li)
          IPA="/tmp/multible.ipa"
          touch $IPA
